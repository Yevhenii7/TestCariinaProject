...
public class WebSampleTest extends AbstractTest {
    ...
    public void testModelSpecs() {
        ...
        // Select phone model
        ModelInfoPage productInfoPage = productsPage.selectModel("Galaxy F62");
        ...
        Assert.assertEquals(productInfoPage.readRam(), "8GB RAM", "Invalid ram info!");
        Assert.assertEquals(productInfoPage.readBattery(), "7000mAh", "Invalid battery info!");
    }
